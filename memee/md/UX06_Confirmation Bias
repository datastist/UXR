## Confirmation Bias สิ่งที่ต้องระวังในงาน Research
...
เหตุผลนั้นก็จะฟังดูเข้าหูไปหมด 
และจบลงที่เราไปสอยของชิ้นนั้นมาครอบครอง 
...
![c](https://sv1.picz.in.th/images/2022/07/31/XZ5lAf.md.png)
...
>นักวิจัยทุกคนรู้ดีว่าสิ่งที่สำคัญมาก ๆ ในการทำวิจัยคือ
การตั้งสมมติฐาน และหลายครั้งที่ออกไปเก็บข้อมูลจริงกับ Participant ผ่านการสัมภาษณ์ Bias นี้จะเกิดขึ้นง่ายมาก ๆ หากเราลืมตัวไป

>อาจเกิดได้จากการที่ Participant ตอบคำถามแล้วดันตรงกับสมมติฐานเรา !
เราเลยถามเจาะเรื่องนี้ โดยอาจจะใช้คำถามชี้นำโดยไม่รู้ และอาจจะทำให้ลดความสำคัญในบางประเด็นไป ทำให้สุดท้ายแล้ว ผลออกมาตรงกับสมมติฐาน 
ถึงแม้ว่าจริง ๆ แล้ว อาจจะไม่เป็นเช่นนั้นเลยก็ได้
...
>ดังนั้นจึงเป็นเรื่องง่ายมากที่เราจะมองหากับข้อมูลที่เราต้องการทดสอบสมมติฐานก่อนซึ่งอาจจะทำให้เรา Ignore ข้อมูล หรือ Insight ชุดอื่น ๆ 
ที่สำคัญ และเป็นประโยชน์ ซึ่งอาจจะมาหักล้างสมมติฐาน และเป็น Findings ใหม่เลยก็ได้ 
...
>บางครั้งระหว่างการสัมภาษณ์ Participant ถามคำถามบางอย่างเกี่ยวกับ
หัวข้อการสัมภาษณ์โดยที่ไม่ได้คิดอะไร 
แต่เราในฐานะนักวิจัยก็เผลอตอบ Yes / No ซึ่งเป็นการให้ข้อมูลไปแบบไม่รู้ตัว 
นี่ก็เป็นการส่งเริม Confimation Bias ให้ Participant แบบที่เราไม่ได้ตั้งใจเช่นกัน 
...
เอาจริง ๆ มันยากมากที่จะลด Bias นี้ 
แต่ในฐานะที่เป็นนักวิจัย เราต้องลด ละ เลิก ให้ได้มากที่สุด วิธีที่เราใช้บ่อย ๆ มีตามนี้เลย 
